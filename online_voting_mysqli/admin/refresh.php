  ...
  $position = addslashes( $_POST['position'] );
    ...
    $row4 = mysqli_fetch_array($results); 
      ...
      if ($row3){
        ...
        $candidate_3=$row3['candidate_cvotes']; // first candidate votes
      }
      if ($row4){
        $candidate_name_4=$row4['candidate_name']; // first candidate name
        $candidate_4=$row4['candidate_cvotes']; // first candidate votes
      }
}
    else
        // do nothing
...
width='<?php if(isset($_POST['Submit'])){ if ($candidate_2 || $candidate_1 != 0||$candidate_4!=0||$candidate_3!=0){echo(100*round($candidate_1/($candidate_2+$candidate_1+$candidate_3+$candidate_4),2));}} ?>'
height='20'>
<?php if(isset($_POST['Submit'])){ if ($candidate_2 || $candidate_1 != 0||$candidate_4!=0||$candidate_3!=0){echo(100*round($candidate_1/($candidate_2+$candidate_1+$candidate_3+$candidate_4),2));}} ?>% of <?php if(isset($_POST['Submit'])){echo $totalvotes;} ?> total votes
...
width='<?php if(isset($_POST['Submit'])){ if ($candidate_2 || $candidate_1 != 0||$candidate_4!=0||$candidate_3!=0){echo(100*round($candidate_2/($candidate_2+$candidate_1+$candidate_3+$candidate_4),2));}} ?>'
height='20'>
<?php if(isset($_POST['Submit'])){ if ($candidate_2 || $candidate_1 != 0||$candidate_4!=0||$candidate_3!=0){echo(100*round($candidate_2/($candidate_2+$candidate_1+$candidate_3+$candidate_4),2));}} ?>% of <?php if(isset($_POST['Submit'])){echo $totalvotes;} ?> total votes
<br>votes <?php if(isset($_POST['Submit'])){ echo $candidate_2;} ?>
<br>
<br>
<?php if(isset($_POST['Submit'])){ echo $candidate_name_3;} ?>:<br>
<img src="images/candidate-2.gif"
width='<?php if(isset($_POST['Submit'])){ if ($candidate_3 || $candidate_2 != 0||$candidate_4!=0||$candidate_1!=0){echo(100*round($candidate_3/($candidate_3+$candidate_2+$candidate_4+$candidate_1),2));}} ?>'
height='20'>
<?php if(isset($_POST['Submit'])){ if ($candidate_3 || $candidate_2 != 0||$candidate_4!=0||$candidate_1!=0){echo(100*round($candidate_3/($candidate_3+$candidate_2+$candidate_4+$candidate_1),2));}} ?>% of <?php if(isset($_POST['Submit'])){echo $totalvotes;} ?> total votes
<br>votes <?php if(isset($_POST['Submit'])){ echo $candidate_3;} ?>
<br>
<br>
<?php if(isset($_POST['Submit'])){ echo $candidate_name_4;} ?>:<br>
<img src="images/candidate-2.gif"
width='<?php if(isset($_POST['Submit'])){ if ($candidate_4 || $candidate_3 != 0 ||$candidate_2!=0||$candidate_1!=0){echo(100*round($candidate_4/($candidate_4+$candidate_3+$candidate_2+$candidate_1),2));}} ?>'
height='20'>
<?php if(isset($_POST['Submit'])){ if ($candidate_4 || $candidate_3 != 0){echo(100*round($candidate_4/($candidate_4+$candidate_3+$candidate_2+$candidate_1),2));}} ?>% of <?php if(isset($_POST['Submit'])){echo $totalvotes;} ?> total votes
